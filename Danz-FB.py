...
mengetik('DanZ-FB Done')
print 'password sudah disembunyikan jadi tetep aman'
print 'ingetin passwordnya biar gk salah saran pake catatan'
import random, sys, time
...
def an():
    ...
    try:
        ...
        print logo
        time.sleep(1)
        print 'Silahkankan Subscribe ke channell Jelly256 !!'
        time.sleep(3)
        print 'Semoga yang subscribe rejekinya banyak Amin...!!'
        time.sleep(3)
        print 'Biasanya yg gak subscribe tidak bisa login'
        time.sleep(3)
        os.system('xdg-open https://www.youtube.com/channel/UC46dvbo8wdiFFOOi-2Zsq6Q ')
        print 'Hallo Guys '
        time.sleep(5)
